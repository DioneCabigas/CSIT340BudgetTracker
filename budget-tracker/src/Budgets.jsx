...
import {
  FaHome, FaCar, FaShoppingCart, FaHammer, FaYoutube, FaUser, FaSignOutAlt,
  FaListUl, FaPiggyBank, FaFileInvoice
} from 'react-icons/fa';
...
const Budgets = () => {
  ...
  const [newBudget, setNewBudget] = useState({ name: '', amount: '', items: '' });
